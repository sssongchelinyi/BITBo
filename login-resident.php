                    ...
                    <li class="nav-item me-0">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="login-brgyofficial.php">Brgy. Official</a>
                    ...
                    <div class="mt-md-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Don't have an account?<a href="landing-bitbo.php" class="text-muted ms-1"><b>Register</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
                    </div>
    ...
    <footer class="bg-dark py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mt-5">
                        <p class="text-muted mt-4 text-center mb-0">© 2022 - <script>
                                document.write(new Date().getFullYear())
                            </script> BrgyMS | iHealth Team</p>
                    </div>
                </div>
            </div>
        </div>
